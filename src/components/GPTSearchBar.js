...
const GPTSearchBar = () => {
    ...
    const handleGptSearchClick = async () => {
        ...
        const gptQuery = "Act as a Movie recommendation system and suggest some movies for the query : "+searchText.current.value+ "only give me names 5 movies, comma seperated such as 3 idiots, Dangal, 12th Fail, Padmavat, Befikre"
        ...
        dispatch(addGptMovieResult({moveiNames: gptMovies, movieResults: TMDBresults}))
    }
    return <div className="pt-[35%] md:pt-[10%] flex justify-center">
        <form className="w-full md:w-1/2 bg-black grid grid-cols-12" onSubmit={(e) => e.preventDefault()}>
            <input ref={searchText} type="text" className="p-4 m-4 col-span-9" placeholder={lang[langKey].gptSeachPlaceholder}/>
